...
$sql = "INSERT INTO `Designers` (`Designer_pasport_number` ,`Surname` ,  `Name` ,  `Father_name` ,  `Salary`  ) VALUES( '{$_POST['Designer_pasport_number']}', '{$_POST['Surname']}' ,  '{$_POST['Name']}' ,  '{$_POST['Father_name']}' ,  '{$_POST['Salary']}'  ) "; 
